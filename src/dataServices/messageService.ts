...
class MessageService {
    ...
    private MESSAGES: Array<IMessageInformation> = [
        ...
        { Id: 3, Author: "Oni", CreationDate: new Date("03/01/2011"), Message: "Pong" },
        { Id: 4, Author: "Basque", CreationDate: new Date("04/01/2011"), Message: "Ping" },
        { Id: 5, Author: "Oni", CreationDate: new Date("05/01/2011"), Message: "1-0" },
        { Id: 6, Author: "Basque", CreationDate: new Date("06/01/2011"), Message: "Ping" },
        { Id: 999, Author: "Oni", CreationDate: new Date("07/01/2011"), Message: "1-1" }
    ];
    Get = () => {
